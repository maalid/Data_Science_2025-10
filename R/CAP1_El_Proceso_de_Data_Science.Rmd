...
<center>![](C:/mii/Data_Science_2025-10/images/Figura_1_Capitulo_1_El_Proceso_de_Data_Science.jpg){style="border-radius: 5px;"}</center>
...
::: {style="background-color: LightGray; padding: 20px; border-radius: 25px; opacity: 0.8"}
<center>![](C:/mii/Data_Science_2025-10/images/Figura_2_Capitulo_1_El_Proceso_de_Data_Science.jpg){style="border-radius: 5px;"}</center>
...
<center>![](C:/mii/Data_Science_2025-10/images/Figura_4_Capitulo_1_El_Proceso_de_Data_Science.png){style="border-radius: 5px;" width="590"}</center>
