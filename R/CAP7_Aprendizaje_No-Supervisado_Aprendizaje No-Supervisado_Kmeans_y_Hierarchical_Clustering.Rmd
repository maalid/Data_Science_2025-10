...
USArrests_data <- utils::read.csv("data/USArrests.csv", stringsAsFactors = FALSE)
USArrests_data
```
...
utils::head(USArrests_scaled_data)
...
```{r}
distance <- factoextra::get_dist(x = USArrests_scaled_data,
                                 method = "euclidean")

factoextra::fviz_dist(dist.obj = distance, 
...
```{r}
model_k2 <- stats::kmeans(x = USArrests_scaled_data, 
                          centers = 2, 
                          nstart = 25)
utils::str(model_k2)
```
...
```{r}
factoextra::fviz_cluster(object = model_k2, 
...
ggplot2::ggplot(data = x) +
    ggplot2::aes(x = UrbanPop, y = Murder, color = factor(cluster), label = State) +
    ggplot2::geom_text()
```
...
```{r}
model_k3 <- stats::kmeans(x = USArrests_scaled_data, 
                          centers = 3, 
                          nstart = 25)

model_k4 <- stats::kmeans(x = USArrests_scaled_data, 
                          centers = 4, 
                          nstart = 25)

model_k5 <- stats::kmeans(x = USArrests_scaled_data, 
                          centers = 5, 
                          nstart = 25)

# plots to compare
p1 <- factoextra::fviz_cluster(object = model_k2, 
                               geom = "point", 
                               data = USArrests_scaled_data) + 
  ggplot2::ggtitle("k = 2")

p2 <- factoextra::fviz_cluster(object = model_k3, 
                               geom = "point",  
                               data = USArrests_scaled_data) + 
  ggplot2::ggtitle("k = 3")

p3 <- factoextra::fviz_cluster(object = model_k4, 
                               geom = "point",  
                               data = USArrests_scaled_data) + 
  ggplot2::ggtitle("k = 4")

p4 <- factoextra::fviz_cluster(object = model_k5, 
                               geom = "point",  
                               data = USArrests_scaled_data) + 
  ggplot2::ggtitle("k = 5")
...
factoextra::fviz_nbclust(x = USArrests_scaled_data, 
                         FUNcluster = kmeans, 
                         method = "wss")
```
...
```{r}
set.seed(123)
gap_stat <- cluster::clusGap(x = USArrests_scaled_data, 
                             FUNcluster = kmeans, 
                             nstart = 25,
                             K.max = 10, 
                             B = 50)
...
factoextra::fviz_gap_stat(gap_stat, maxSE = list(method = "firstmax", SE.factor = 1))
```
...
set.seed(123)
best_model <- stats::kmeans(USArrests_scaled_data, centers = 4, nstart = 25)
print(best_model)
```
...
```{r}
factoextra::fviz_cluster(object = best_model, 
                         data = USArrests_scaled_data)
```
...
ggplot2::ggplot(data = USArrests_data) + 
  ggplot2::aes(x = Murder, color = Cluster, fill = Cluster) + 
  ggplot2::geom_density(alpha = 0.3) + 
  ggplot2::theme_light()

ggplot2::ggplot(data = USArrests_data) + 
  ggplot2::aes(x = Assault, color = Cluster, fill = Cluster) + 
  ggplot2::geom_density(alpha = 0.3) + 
  ggplot2::theme_light()

ggplot2::ggplot(data = USArrests_data) + 
  ggplot2::aes(x = UrbanPop, color = Cluster, fill = Cluster) + 
  ggplot2::geom_density(alpha = 0.3) + 
  ggplot2::theme_light()

ggplot2::ggplot(data = USArrests_data) + 
  ggplot2::aes(x = Rape, color = Cluster, fill = Cluster) + 
  ggplot2::geom_density(alpha = 0.3) + 
  ggplot2::theme_light()
...
![](images/Figura_1_Capitulo_7_Aprendizaje_No_Supervisado_k-means_y_Agrupamiento_Jerarquico.png){style="border-radius: 5px;" width="450"}
...
![](images/Figura_2_Capitulo_7_Aprendizaje_No_Supervisado_k-means_y_Agrupamiento_Jerarquico.jpg){style="border-radius: 5px;" width="450"}
...
hc_model_complete <- stats::hclust(d = distance, 
                                   method = "complete")

# clustering jerarquico usando average Linkage
hc_model_average <- stats::hclust(d = distance, 
                                  method = "average")

# clustering jerarquico usando single Linkage
hc_model_single <- stats::hclust(d = distance, 
                                 method = "single")

# clustering jerarquico usando ward Linkage
hc_model_ward <- stats::hclust(d = distance, 
                               method = "ward.D")
...
ag_model_average <- cluster::agnes(x = USArrests_scaled_data,
                                   metric = "euclidean",
                                   method = "average")

ag_model_single <- cluster::agnes(x = USArrests_scaled_data,
                                  metric = "euclidean",
                                  method = "single")

ag_model_complete <- cluster::agnes(x = USArrests_scaled_data,
                                    metric = "euclidean",
                                    method = "complete")

ag_model_ward <- cluster::agnes(x = USArrests_scaled_data,
                                metric = "euclidean",
                                method = "ward")
...
sub_grp <- stats::cutree(tree = hc_model_ward, 
                         k = 4)
...
stats::rect.hclust(hc_model_ward, k = 4, border = 2:5)
```
...
```{r}
factoextra::fviz_cluster(list(data = USArrests_scaled_data, cluster = sub_grp))
```
...
ggplot2::ggplot(data = USArrests_data) + 
  ggplot2::aes(x = Murder, color = Cluster_hc, fill = Cluster_hc) + 
  ggplot2::geom_density(alpha = 0.3) + 
  ggplot2::theme_light()

ggplot2::ggplot(data = USArrests_data) + 
  ggplot2::aes(x = Assault, color = Cluster_hc, fill = Cluster_hc) + 
  ggplot2::geom_density(alpha = 0.3) + 
  ggplot2::theme_light()

ggplot2::ggplot(data = USArrests_data) + 
  ggplot2::aes(x = UrbanPop, color = Cluster_hc, fill = Cluster_hc) + 
  ggplot2::geom_density(alpha = 0.3) + 
  ggplot2::theme_light()

ggplot2::ggplot(data = USArrests_data) + 
  ggplot2::aes(x = Rape, color = Cluster_hc, fill = Cluster_hc) + 
  ggplot2::geom_density(alpha = 0.3) + 
  ggplot2::theme_light()
```
...
diana_model <- cluster::diana(x = USArrests_scaled_data,
                              metric = "euclidean")
...
# Dendrogram
cluster::pltree(diana_model, cex = 0.6, hang = -1, main = "Dendrogram of diana")
```
...
hc_model_agnes <- cluster::agnes(USArrests_scaled_data,
                                 method = "ward")
sub_grp_agnes <- stats::cutree(stats::as.hclust(hc_model_agnes), 
                               k = 4)
table(sub_grp_agnes)
plot(stats::as.hclust(hc_model_agnes), cex = 0.6)
stats::rect.hclust(stats::as.hclust(hc_model_agnes), k = 4, border = 2:5)

# Cut diana() tree into 4 groups
hc_model_diana <- cluster::diana(USArrests_scaled_data)
sub_grp_diana <- stats::cutree(stats::as.hclust(hc_model_diana), 
                               k = 4)
table(sub_grp_diana)
plot(stats::as.hclust(hc_model_diana), cex = 0.6)
stats::rect.hclust(stats::as.hclust(hc_model_diana), k = 4, border = 2:5)
```
